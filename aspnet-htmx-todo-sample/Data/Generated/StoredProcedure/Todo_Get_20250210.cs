...
{
    public partial class Todo_Get_20250210 : StoredProcedureWithResultSet<Todo_Get_20250210.ResultSet>
    {
        public partial class ResultSet : StoredProcedureResultSet
        {
            ...
            internal ResultSet(Todo_Get_20250210 storedProcedure)
            {
            ...
            public override String ToString()
            {
                ...
                sb.AppendLine("<Todo_Get_20250210.ResultSet>");
        ...
        public const String Name = "Todo_Get_20250210";
        private Boolean? _DueDateNotNull;
        ...
        public Boolean? DueDateNotNull
        {
            get
            {
                return _DueDateNotNull;
            }
            set
            {
                _DueDateNotNull = value;
            }
        }

        public Todo_Get_20250210()
        {
        ...
        public override DbCommand CreateCommand(Database database)
        {
            ...
            p = db.CreateParameter("@DueDateNotNull", SqlDbType.Bit, null, null);
            p.SourceColumn = p.ParameterName;
            p.Direction = ParameterDirection.Input;
            p.Value = this.DueDateNotNull;
        ...
        public override Todo_Get_20250210.ResultSet CreateResultSet()
        {
            return new ResultSet(this);
        }
        protected override void SetResultSet(Todo_Get_20250210.ResultSet resultSet, IDataReader reader)
        {
            var r = resultSet;
            Int32 index = -1;
            try
        ...
        public override String ToString()
        {
            ...
            sb.AppendLine("<Todo_Get_20250210>");
            sb.AppendFormat("DueDateNotNull={0}", this.DueDateNotNull); sb.AppendLine();
            return sb.ToString();
        }
    }
}
