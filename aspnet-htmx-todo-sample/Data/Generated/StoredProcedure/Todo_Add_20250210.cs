...
{
    public partial class Todo_Add_20250210 : StoredProcedure
    {
        public const String Name = "Todo_Add_20250210";
        ...
        public override DbCommand CreateCommand(Database database)
        {
            ...
            p = db.CreateParameter("@CreateTime", SqlDbType.DateTimeOffset, null, 7);
            p.SourceColumn = p.ParameterName;
            p.Direction = ParameterDirection.Input;
            p.Value = this.CreateTime;
            p.Value = p.Value ?? DBNull.Value;
            cm.Parameters.Add(p);
        ...
        public override String ToString()
        {
            ...
            sb.AppendLine("<Todo_Add_20250210>");
